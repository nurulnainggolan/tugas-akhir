    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            @if (Auth::check() && Auth::user()->roles == 'admin')
                ...
                <li class="menu-header">Master Menu</li>
                ...
                <li class="{{ request()->routeIs('absensi.*') ? 'active' : '' }}"><a class="nav-link"
                        href="{{ route('absensi.index') }}"><i class="fas fa-book"></i> <span>Absensi</span></a></li>
                <li class="{{ request()->routeIs('nilai.*') ? 'active' : '' }}"><a class="nav-link"
                        href="{{ route('nilai.index') }}"><i class="fas fa-book"></i> <span>Nilai</span></a>
                </li>
